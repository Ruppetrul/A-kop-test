...
use App\GraphQL\Types\InviteCompanyResponse;
...
return [
    'route' => [
        ...
        'controller' => \App\Http\Controllers\LocalGraphQLController::class . '@query',
    ...
    'schemas' => [
        ...
        'inviteCompany' => [
            ...
            'mutation' => [
                App\GraphQL\Mutations\InviteCompany::class,
            ],
            // The types only available in this schema
            'types' => [
                // ExampleType::class,
                'CustomResponse' => App\GraphQL\Types\InviteCompanyResponse::class,
            ],
